...
/*|--------'--------'--------'--------'--------'--------'--------'--------'--------'--------'--------'--------|*/
  {KC_RGUI , KC_LALT, KC_LGUI,   LOWER,   LOWER,   LT_TC,   LT_TC,   RAISE, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY}
/*,--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------.*/
},
...
/*|--------'--------'--------'--------'--------'--------'--------'--------'--------'--------'--------'--------|*/
  {BACKLIT , KC_PSCR, _______, _______, _______, _______, _______, _______, KC_MPRV, KC_MSTP, KC_MSEL, KC_MUTE}
/*,--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------.*/
},
...
/*,--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------.*/
  {_______ , _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______}
/*|--------'--------'--------'--------'--------'--------'--------'--------'--------'--------'--------'--------|*/
  {_______ , KC_ACL0, KC_BTN4, _______, KC_BTN5, _______, _______, KC_WH_L, KC_MS_U, KC_WH_R, KC_BTN2, _______},
/*|--------'--------'--------'--------'--------'--------'--------'--------'--------'--------'--------'--------|*/
